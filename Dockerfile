...
ENV DNX_VERSION 1.0.0-rc1-update2
...
RUN apt-get update && apt-get -y install unzip libc6-dev libicu-dev sqlite3 libsqlite3-dev
...
RUN LIBUV_VERSION=1.4.2 \
	&& apt-get update \
	&& apt-get -y install autoconf automake build-essential libtool redis-server nodejs \
